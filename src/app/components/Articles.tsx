  ...
  return (
    <div className="mt-[120px] w-[800px] h-[208px] mx-auto">
      <div className='leading-normal'>
        ...
        <Link className="text-[#3294F8]" href="#">
          Dynamic typing
        </Link>
      ...
      <div className="bg-[#112131]">
        <p className="text-white">
          <span>let</span> foo = <span className="text-[#6AD445]">42</span>;
          <span className="text-[#4F6173] ml-4">// foo is now a number</span>
        </p>

        <p className="text-white">
          foo = <span className="text-[#6AD445]">'bar'</span>;
          <span className="text-[#4F6173] ml-4">// foo is now a string</span>
        </p>

        <p className='text-white'>
          foo = <span className="text-[#6AD445]">true</span>;
          <span className="text-[#4F6173] ml-4">// foo is now a boolean</span>
        </p>
